...
#ifndef MStoneRubble_h
#define MStoneRubble_h
...
class MStoneRubble : public Material {
...
public:
    ...
    MStoneRubble(Material::MaterialType mt) : Material(mt) {}
    string getName() override { return "Stone Rubble"; }
    
    float isOpaque() override { return 0.1f; }
