...
#ifndef MFortressWall_h
#define MFortressWall_h

#include <stdio.h>

#include "Material.h"

class MFortressWall : public Material {
    
public:

    
    MFortressWall(Material::MaterialType mt) : Material(mt) {}
    string getName() override { return "Fortress Wall"; }
