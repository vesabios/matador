...
#ifndef MFortressFloor_h
#define MFortressFloor_h

#include <stdio.h>

#include "Material.h"

class MFortressFloor : public Material {
    
public:

    
    MFortressFloor(Material::MaterialType mt) : Material(mt) {}
    string getName() override { return "Fortress Floor"; }
